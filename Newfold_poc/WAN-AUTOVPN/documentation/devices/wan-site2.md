...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.66.24/24 | - |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.101.255.4/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | isp_INTERNET-1111 | routed | - | 172.18.6.2/24 | default | - | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.101.254.4/32 |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| default | 0.0.0.0/0 | 172.18.6.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route 0.0.0.0/0 172.18.6.1
```
...
router bgp 65000
   ...
   neighbor 10.255.0.2 description wan-hub2
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.101.254.4:0 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 10.101.254.4:0 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.101.254.4:0 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.101.254.4:0 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.101.254.4:0
```
...
| -------------- | -------------- | ---------------------- |
| Ethernet1 | - | internet-wan-hub1-Ethernet1<br>internet-wan-hub2-Ethernet1 |
...
| 10.255.0.2 | wan-hub2 | 172.18.4.6 |
...
router path-selection
   ...
   path-group internet id 101
      ...
      local interface Ethernet1
         stun server-profile internet-wan-hub1-Ethernet1 internet-wan-hub2-Ethernet1
      !
      peer dynamic
      !
...
| -------------- | ---------- | ----------- | ---- |
| internet-wan-hub1-Ethernet1 | 172.18.4.2 | STUN-DTLS | 3478 |
| internet-wan-hub2-Ethernet1 | 172.18.4.6 | STUN-DTLS | 3478 |
...
stun
   client
      server-profile internet-wan-hub1-Ethernet1
         ip address 172.18.4.2
         ssl profile STUN-DTLS
      server-profile internet-wan-hub2-Ethernet1
         ip address 172.18.4.6
         ssl profile STUN-DTLS
```
