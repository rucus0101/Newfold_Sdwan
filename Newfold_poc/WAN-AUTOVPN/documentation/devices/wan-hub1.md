...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.0.10/24 | - |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | isp_INTERNET-1111 | routed | - | 172.18.4.2/30 | default | - | False | - | - |
...
| --- | ------------------ | ----------- | -------------- | ----------------------- | --- | ---------- | ------ |
| default | 0.0.0.0/0 | 172.18.4.1 | - | 1 | - | - | - |

#### Static Routes Device Configuration

```eos
!
ip route 0.0.0.0/0 172.18.4.1
```
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.101.254.1:0 additive | - | - |
...
route-map RM-CONN-2-BGP permit 10
   ...
   set extcommunity soo 10.101.254.1:0 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.101.254.1:0 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.101.254.1:0
```
...
| Name | Prefixes |
| ---- | -------- |
| PFX-LOCAL-VTEP-IP | 10.101.255.1/32 |
