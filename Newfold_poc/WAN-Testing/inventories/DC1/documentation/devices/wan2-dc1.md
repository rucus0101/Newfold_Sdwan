...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.66.22/24 | 192.168.66.1 |
...
| ----------- | ------------ | ---------- | -------- | -------- |
| DP-IKE-POLICY | - | - | - | 10.100.255.2 |
| CP-IKE-POLICY | - | - | - | 10.100.255.2 |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.100.255.2/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1.10 | P2P_LINK_TO_BORDER1-DC1_Ethernet4.10_vrf_guest | l3dot1q | - | 10 |
| Ethernet1.20 | P2P_LINK_TO_BORDER1-DC1_Ethernet4.20_vrf_data | l3dot1q | - | 20 |
| Ethernet2.10 | P2P_LINK_TO_BORDER2-DC1_Ethernet4.10_vrf_guest | l3dot1q | - | 10 |
| Ethernet2.20 | P2P_LINK_TO_BORDER2-DC1_Ethernet4.20_vrf_data | l3dot1q | - | 20 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_BORDER1-DC1_Ethernet4 | routed | - | 10.100.0.133/31 | default | 9214 | True | - | - |
| Ethernet1.10 | P2P_LINK_TO_BORDER1-DC1_Ethernet4.10_vrf_guest | l3dot1q | - | 10.100.0.133/31 | guest | 9214 | False | - | - |
| Ethernet1.20 | P2P_LINK_TO_BORDER1-DC1_Ethernet4.20_vrf_data | l3dot1q | - | 10.100.0.133/31 | data | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_BORDER2-DC1_Ethernet4 | routed | - | 10.100.0.135/31 | default | 9214 | True | - | - |
| Ethernet2.10 | P2P_LINK_TO_BORDER2-DC1_Ethernet4.10_vrf_guest | l3dot1q | - | 10.100.0.135/31 | guest | 9214 | False | - | - |
| Ethernet2.20 | P2P_LINK_TO_BORDER2-DC1_Ethernet4.20_vrf_data | l3dot1q | - | 10.100.0.135/31 | data | 9214 | False | - | - |
| Ethernet3 | mpls-sp-1_DC1-MPLS-4 | routed | - | 172.18.4.2/24 | default | - | True | - | - |
| Ethernet4 | isp-1_DC1-INET-4 | routed | - | 100.64.4.2/24 | default | - | True | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_BORDER1-DC1_Ethernet4
   shutdown
   mtu 9214
   no switchport
   ip address 10.100.0.133/31
!
interface Ethernet1.10
   description P2P_LINK_TO_BORDER1-DC1_Ethernet4.10_vrf_guest
   no shutdown
   mtu 9214
...
interface Ethernet1.20
   description P2P_LINK_TO_BORDER1-DC1_Ethernet4.20_vrf_data
   no shutdown
   mtu 9214
...
!
interface Ethernet2
   description P2P_LINK_TO_BORDER2-DC1_Ethernet4
   shutdown
   mtu 9214
   no switchport
   ip address 10.100.0.135/31
!
interface Ethernet2.10
   description P2P_LINK_TO_BORDER2-DC1_Ethernet4.10_vrf_guest
   no shutdown
   mtu 9214
   encapsulation dot1q vlan 10
   vrf guest
...
interface Ethernet2.20
   description P2P_LINK_TO_BORDER2-DC1_Ethernet4.20_vrf_data
   no shutdown
   mtu 9214
   encapsulation dot1q vlan 20
   vrf data
...
interface Ethernet3
   ...
   shutdown
   no switchport
   ip address 172.18.4.2/24
!
interface Ethernet4
   description isp-1_DC1-INET-4
   shutdown
   no switchport
   ip address 100.64.4.2/24
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.100.254.2/32 |
...
| default | 172.18.0.0/16 | 172.18.4.1 | - | 1 | - | - | - |
| default | 100.64.0.0/16 | 100.64.4.1 | - | 1 | - | - | - |
...
ip route 172.18.0.0/16 172.18.4.1
ip route 100.64.0.0/16 100.64.4.1
```
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.100.0.132 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.0.134 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.100.0.132 | 65101 | data | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.0.134 | 65101 | data | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.0.132 | 65101 | guest | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.0.134 | 65101 | guest | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| data | 10.100.254.2:20 | connected |
| default | 10.100.254.2:1 | - |
| guest | 10.100.254.2:10 | connected |
...
router bgp 65000
   ...
   neighbor 10.100.0.132 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.0.132 remote-as 65101
   neighbor 10.100.0.132 description border1-dc1_Ethernet4
   neighbor 10.100.0.134 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.100.0.134 remote-as 65101
   neighbor 10.100.0.134 description border2-dc1_Ethernet4
   ...
   vrf data
      ...
      neighbor 10.100.0.132 remote-as 65101
      neighbor 10.100.0.132 peer group IPv4-UNDERLAY-PEERS
      neighbor 10.100.0.132 description border1-dc1_Ethernet4.20_vrf_data
      neighbor 10.100.0.134 remote-as 65101
      neighbor 10.100.0.134 peer group IPv4-UNDERLAY-PEERS
      neighbor 10.100.0.134 description border2-dc1_Ethernet4.20_vrf_data
   ...
   vrf guest
      ...
      neighbor 10.100.0.132 remote-as 65101
      neighbor 10.100.0.132 peer group IPv4-UNDERLAY-PEERS
      neighbor 10.100.0.132 description border1-dc1_Ethernet4.10_vrf_guest
      neighbor 10.100.0.134 remote-as 65101
      neighbor 10.100.0.134 peer group IPv4-UNDERLAY-PEERS
      neighbor 10.100.0.134 description border2-dc1_Ethernet4.10_vrf_guest
      redistribute connected
```
...
| Sequence | Action |
| -------- | ------ |
| 10 | permit 10.100.254.0/25 eq 32 |

##### PL-WAN-HA-PEER-PREFIXES

| Sequence | Action |
| -------- | ------ |
| 10 | permit 10.100.0.128/31 |
| 20 | permit 10.100.0.130/31 |

##### PL-WAN-HA-PREFIXES

| Sequence | Action |
| -------- | ------ |
| 10 | permit 10.100.0.132/31 |
| 20 | permit 10.100.0.134/31 |
...
| 40 | permit | - | extcommunity soo 10.100.254.1:100 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.100.254.1:100 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 10.100.254.1:100 additive | - | - |
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.100.254.1:100 |
...
| Router IP | Name | IPv4 address(es) |
| --------- | ---- | ---------------- |
| 10.100.255.1 | wan1-dc1 | 10.100.0.129<br>10.100.0.131 |
...
router path-selection
   ...
   path-group LAN_HA id 65535
      ...
      !
      peer static router-ip 10.100.255.1
         name wan1-dc1
         ipv4 address 10.100.0.129
         ipv4 address 10.100.0.131
   !
