...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.66.21/24 | 192.168.66.1 |
...
| ----------- | ------------ | ---------- | -------- | -------- |
| DP-IKE-POLICY | - | - | - | 10.100.255.1 |
| CP-IKE-POLICY | - | - | - | 10.100.255.1 |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.100.255.1/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1.10 | P2P_LINK_TO_BORDER1-DC1_Ethernet3.10_vrf_guest | l3dot1q | - | 10 |
| Ethernet1.20 | P2P_LINK_TO_BORDER1-DC1_Ethernet3.20_vrf_data | l3dot1q | - | 20 |
| Ethernet2.10 | P2P_LINK_TO_BORDER2-DC1_Ethernet3.10_vrf_guest | l3dot1q | - | 10 |
| Ethernet2.20 | P2P_LINK_TO_BORDER2-DC1_Ethernet3.20_vrf_data | l3dot1q | - | 20 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_BORDER1-DC1_Ethernet3 | routed | - | 10.100.0.129/31 | default | 9214 | False | - | - |
| Ethernet1.10 | P2P_LINK_TO_BORDER1-DC1_Ethernet3.10_vrf_guest | l3dot1q | - | 10.100.0.129/31 | guest | 9214 | False | - | - |
| Ethernet1.20 | P2P_LINK_TO_BORDER1-DC1_Ethernet3.20_vrf_data | l3dot1q | - | 10.100.0.129/31 | data | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_BORDER2-DC1_Ethernet3 | routed | - | 10.100.0.131/31 | default | 9214 | False | - | - |
| Ethernet2.10 | P2P_LINK_TO_BORDER2-DC1_Ethernet3.10_vrf_guest | l3dot1q | - | 10.100.0.131/31 | guest | 9214 | False | - | - |
| Ethernet2.20 | P2P_LINK_TO_BORDER2-DC1_Ethernet3.20_vrf_data | l3dot1q | - | 10.100.0.131/31 | data | 9214 | False | - | - |
| Ethernet3 | mpls-sp-1_DC1-MPLS-3 | routed | - | 172.18.3.2/24 | default | - | False | - | - |
| Ethernet4 | isp-1_DC1-INET-3 | routed | - | 100.64.3.2/24 | default | - | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.100.254.1/32 |
...
| default | 172.18.0.0/16 | 172.18.3.1 | - | 1 | - | - | - |
| default | 100.64.0.0/16 | 100.64.3.1 | - | 1 | - | - | - |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.100.0.128 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.0.130 | 65101 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.100.0.128 | 65101 | data | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.0.130 | 65101 | data | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.0.128 | 65101 | guest | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.100.0.130 | 65101 | guest | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| data | 10.100.254.1:20 | connected |
| default | 10.100.254.1:1 | - |
| guest | 10.100.254.1:10 | connected |
...
| Router IP | Name | IPv4 address(es) |
| --------- | ---- | ---------------- |
| 10.100.255.2 | wan2-dc1 | 10.100.0.133<br>10.100.0.135 |
