...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.66.25/24 | 192.168.66.1 |
...
| ----------- | ------------ | ---------- | -------- | -------- |
| DP-IKE-POLICY | - | - | - | 10.102.255.1 |
| CP-IKE-POLICY | - | - | - | 10.102.255.1 |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.102.255.1/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1.10 | P2P_LINK_TO_SPINE1-SITE2_Ethernet3.10_vrf_guest | l3dot1q | - | 10 |
| Ethernet1.20 | P2P_LINK_TO_SPINE1-SITE2_Ethernet3.20_vrf_data | l3dot1q | - | 20 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_SPINE1-SITE2_Ethernet3 | routed | - | 10.102.0.129/31 | default | 9214 | False | - | - |
| Ethernet1.10 | P2P_LINK_TO_SPINE1-SITE2_Ethernet3.10_vrf_guest | l3dot1q | - | 10.102.0.129/31 | guest | 9214 | False | - | - |
| Ethernet1.20 | P2P_LINK_TO_SPINE1-SITE2_Ethernet3.20_vrf_data | l3dot1q | - | 10.102.0.129/31 | data | 9214 | False | - | - |
| Ethernet3 | mpls-sp-1_SITE2-MPLS-7 | routed | - | 172.18.7.2/24 | default | - | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_SPINE1-SITE2_Ethernet3
   no shutdown
   mtu 9214
   no switchport
   ip address 10.102.0.129/31
!
interface Ethernet1.10
   description P2P_LINK_TO_SPINE1-SITE2_Ethernet3.10_vrf_guest
   no shutdown
   mtu 9214
...
interface Ethernet1.20
   description P2P_LINK_TO_SPINE1-SITE2_Ethernet3.20_vrf_data
   no shutdown
   mtu 9214
...
!
interface Ethernet3
   description mpls-sp-1_SITE2-MPLS-7
   no shutdown
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.102.254.1/32 |
...
| default | 172.18.0.0/16 | 172.18.7.1 | - | 1 | - | - | - |
...
ip route 172.18.0.0/16 172.18.7.1
```
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.102.0.128 | - | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.102.0.128 | - | data | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.102.0.128 | - | guest | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| data | 10.102.254.1:20 | connected |
| default | 10.102.254.1:1 | - |
| guest | 10.102.254.1:10 | connected |
...
router bgp 65000
   ...
   neighbor 10.102.0.128 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.102.0.128 description spine1-site2_Ethernet3
   ...
   vrf data
      ...
      router-id 10.102.254.1
      neighbor 10.102.0.128 peer group IPv4-UNDERLAY-PEERS
      neighbor 10.102.0.128 description spine1-site2_Ethernet3.20_vrf_data
   ...
   vrf guest
      ...
      router-id 10.102.254.1
      neighbor 10.102.0.128 peer group IPv4-UNDERLAY-PEERS
      neighbor 10.102.0.128 description spine1-site2_Ethernet3.10_vrf_guest
      redistribute connected
```
...
| --------- | ---- | ---------------- |
| 10.102.255.2 | wan2-site2 | 10.102.0.131 |
...
| ----------- | ----------- | ------------ | ------------- | ---------------------- | ---------------- |
| LB-DATA-AVT-POLICY-DEFAULT | - | - | - | LAN_HA (1)<br>mpls (1) | False |
| LB-DEFAULT-AVT-POLICY-CONTROL-PLANE | - | - | - | LAN_HA (1)<br>mpls (1) | False |
| LB-DEFAULT-AVT-POLICY-DEFAULT | - | - | - | LAN_HA (1)<br>mpls (1) | False |
| LB-GUEST-AVT-POLICY-DEFAULT | - | - | - | LAN_HA (1)<br>mpls (1) | False |
...
router path-selection
   ...
   path-group LAN_HA id 65535
      ...
      !
      peer static router-ip 10.102.255.2
         name wan2-site2
         ipv4 address 10.102.0.131
   !
