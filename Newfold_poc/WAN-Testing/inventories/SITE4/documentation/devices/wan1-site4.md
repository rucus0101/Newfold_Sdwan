...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.66.28/24 | 192.168.66.1 |
...
| --------- | ---------- | -------- | --- | --------------- | --------------- |
| Dps1 | 10.104.255.1/32 | - | 9214 | Hardware: FLOW-TRACKER |  |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1.10 | guest_10 | l3dot1q | - | 10 |
| Ethernet1.20 | data_20 | l3dot1q | - | 20 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1.10 | guest_10 | l3dot1q | - | 10.204.10.2/24 | guest | - | False | - | - |
| Ethernet1.20 | data_20 | l3dot1q | - | 10.204.20.2/24 | data | - | False | - | - |
| Ethernet4 | isp-1_SITE4-INET-7 | routed | - | 100.64.9.2/24 | default | - | False | - | - |
...
!
interface Ethernet1
   description LEAF1-SITE4_Ethernet1
   no shutdown
   mtu 9214
   no switchport
!
...
interface Ethernet1.20
   ...
   vrf data
   ip address 10.204.20.2/24
!
interface Ethernet4
   description isp-1_SITE4-INET-7
   no shutdown
   no switchport
   ip address 100.64.9.2/24
```
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.104.254.1/32 |
...
| --- | ------------------- | ------------ |
| data | 10.104.254.1:20 | connected |
| default | 10.104.254.1:1 | - |
| guest | 10.104.254.1:10 | connected |
...
| Sequence | Action |
| -------- | ------ |
| 10 | permit 10.104.254.0/25 eq 32 |
...
ip prefix-list PL-LOOPBACKS-EVPN-OVERLAY
   seq 10 permit 10.104.254.0/25 eq 32
```
...
| -------- | ---- | ----- | --- | ------------- | -------- |
| 40 | permit | - | extcommunity soo 10.104.254.1:104 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | ip address prefix-list PL-LOOPBACKS-EVPN-OVERLAY | extcommunity soo 10.104.254.1:104 additive | - | - |
...
| Sequence | Type | Match | Set | Sub-Route-Map | Continue |
| -------- | ---- | ----- | --- | ------------- | -------- |
| 10 | permit | - | extcommunity soo 10.104.254.1:104 additive | - | - |
...
route-map RM-BGP-UNDERLAY-PEERS-IN permit 40
   ...
   set extcommunity soo 10.104.254.1:104 additive
!
...
| --------- | ---- | -------------------- |
| ECL-EVPN-SOO | permit | soo 10.104.254.1:104 |

#### IP Extended Community Lists Device Configuration

```eos
!
ip extcommunity-list ECL-EVPN-SOO permit soo 10.104.254.1:104
```
