...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.66.31/24 | 192.168.66.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | mpls-sp-1_PF-MPLS-1 | routed | - | 172.18.1.2/24 | default | - | False | - | - |
| Ethernet2 | isp-1_PF-INET-1 | routed | - | 100.64.1.2/24 | default | - | False | - | - |
...
!
interface Ethernet1
   description mpls-sp-1_PF-MPLS-1
   no shutdown
   no switchport
   ip address 172.18.1.2/24
!
interface Ethernet2
   description isp-1_PF-INET-1
   no shutdown
   no switchport
...
| default | 172.18.0.0/16 | 172.18.1.1 | - | 1 | - | - | - |
| default | 0.0.0.0/0 | 100.64.1.1 | - | 1 | - | - | - |
...
ip route 172.18.0.0/16 172.18.1.1
ip route 0.0.0.0/0 100.64.1.1
```
