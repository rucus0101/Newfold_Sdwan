...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.66.24/24 | 192.168.66.1 |
...
| --------- | ----------- | -----| ------- | -------------- |
| Ethernet1.10 | P2P_LINK_TO_BORDER1-SITE1_Ethernet4.10_vrf_guest | l3dot1q | - | 10 |
| Ethernet1.20 | P2P_LINK_TO_BORDER1-SITE1_Ethernet4.20_vrf_data | l3dot1q | - | 20 |
| Ethernet2.10 | P2P_LINK_TO_BORDER2-SITE1_Ethernet4.10_vrf_guest | l3dot1q | - | 10 |
| Ethernet2.20 | P2P_LINK_TO_BORDER2-SITE1_Ethernet4.20_vrf_data | l3dot1q | - | 20 |

##### IPv4

| Interface | Description | Type | Channel Group | IP Address | VRF |  MTU | Shutdown | ACL In | ACL Out |
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_BORDER1-SITE1_Ethernet4 | routed | - | 10.101.0.133/31 | default | 9214 | True | - | - |
| Ethernet1.10 | P2P_LINK_TO_BORDER1-SITE1_Ethernet4.10_vrf_guest | l3dot1q | - | 10.101.0.133/31 | guest | 9214 | False | - | - |
| Ethernet1.20 | P2P_LINK_TO_BORDER1-SITE1_Ethernet4.20_vrf_data | l3dot1q | - | 10.101.0.133/31 | data | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_BORDER2-SITE1_Ethernet4 | routed | - | 10.101.0.135/31 | default | 9214 | True | - | - |
| Ethernet2.10 | P2P_LINK_TO_BORDER2-SITE1_Ethernet4.10_vrf_guest | l3dot1q | - | 10.101.0.135/31 | guest | 9214 | False | - | - |
| Ethernet2.20 | P2P_LINK_TO_BORDER2-SITE1_Ethernet4.20_vrf_data | l3dot1q | - | 10.101.0.135/31 | data | 9214 | False | - | - |
| Ethernet3 | mpls-sp-1_SITE1-MPLS-6 | routed | - | 172.18.6.2/24 | default | - | True | - | - |
| Ethernet4 | isp-1_SITE1-INET-6 | routed | - | 100.64.6.2/24 | default | - | True | - | - |
...
interface Ethernet1
   ...
   mtu 9214
   no switchport
   ip address 10.101.0.133/31
!
interface Ethernet1.10
   description P2P_LINK_TO_BORDER1-SITE1_Ethernet4.10_vrf_guest
   no shutdown
   mtu 9214
...
interface Ethernet1.20
   description P2P_LINK_TO_BORDER1-SITE1_Ethernet4.20_vrf_data
   no shutdown
   mtu 9214
...
interface Ethernet2
   ...
   mtu 9214
   no switchport
   ip address 10.101.0.135/31
!
interface Ethernet2.10
   description P2P_LINK_TO_BORDER2-SITE1_Ethernet4.10_vrf_guest
   no shutdown
   mtu 9214
   encapsulation dot1q vlan 10
   vrf guest
...
interface Ethernet2.20
   description P2P_LINK_TO_BORDER2-SITE1_Ethernet4.20_vrf_data
   no shutdown
   mtu 9214
   encapsulation dot1q vlan 20
   vrf data
...
!
interface Ethernet3
   description mpls-sp-1_SITE1-MPLS-6
   shutdown
   no switchport
   ip address 172.18.6.2/24
!
interface Ethernet4
   description isp-1_SITE1-INET-6
   shutdown
   no switchport
   ip address 100.64.6.2/24
```
...
| default | 172.18.0.0/16 | 172.18.6.1 | - | 1 | - | - | - |
| default | 100.64.0.0/16 | 100.64.6.1 | - | 1 | - | - | - |
...
ip route 172.18.0.0/16 172.18.6.1
ip route 100.64.0.0/16 100.64.6.1
```
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- | ------------ |
| 10.101.0.132 | 65111 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.101.0.134 | 65111 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| 10.101.0.132 | 65111 | data | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.101.0.134 | 65111 | data | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.101.0.132 | 65111 | guest | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 10.101.0.134 | 65111 | guest | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| data | 10.101.254.2:20 | connected |
| default | 10.101.254.2:1 | - |
| guest | 10.101.254.2:10 | connected |
...
router bgp 65000
   ...
   neighbor 10.101.0.132 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.101.0.132 remote-as 65111
   neighbor 10.101.0.132 description border1-site1_Ethernet4
   neighbor 10.101.0.134 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.101.0.134 remote-as 65111
   neighbor 10.101.0.134 description border2-site1_Ethernet4
   ...
   vrf data
      ...
      neighbor 10.101.0.132 remote-as 65111
      neighbor 10.101.0.132 peer group IPv4-UNDERLAY-PEERS
      neighbor 10.101.0.132 description border1-site1_Ethernet4.20_vrf_data
      neighbor 10.101.0.134 remote-as 65111
      neighbor 10.101.0.134 peer group IPv4-UNDERLAY-PEERS
      neighbor 10.101.0.134 description border2-site1_Ethernet4.20_vrf_data
   ...
   vrf guest
      ...
      neighbor 10.101.0.132 remote-as 65111
      neighbor 10.101.0.132 peer group IPv4-UNDERLAY-PEERS
      neighbor 10.101.0.132 description border1-site1_Ethernet4.10_vrf_guest
      neighbor 10.101.0.134 remote-as 65111
      neighbor 10.101.0.134 peer group IPv4-UNDERLAY-PEERS
      neighbor 10.101.0.134 description border2-site1_Ethernet4.10_vrf_guest
      redistribute connected
```
...
| Router IP | Name | IPv4 address(es) |
| --------- | ---- | ---------------- |
| 10.101.255.1 | wan1-site1 | 10.101.0.129<br>10.101.0.131 |
...
router path-selection
   ...
   path-group LAN_HA id 65535
      ...
      !
      peer static router-ip 10.101.255.1
         name wan1-site1
         ipv4 address 10.101.0.129
         ipv4 address 10.101.0.131
   !
