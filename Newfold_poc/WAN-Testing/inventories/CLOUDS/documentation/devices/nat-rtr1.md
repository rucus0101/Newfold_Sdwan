...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 192.168.66.12/24 | 192.168.66.1 |
...
| ------ | ---- | ----------- | --------------- | ---------- | ------ |
| 192.168.2.0/24 | - | - | - | - | 192.168.2.2-192.168.2.2 |
| 192.168.3.0/24 | - | - | - | - | 192.168.3.2-192.168.3.2 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | p2p_inet-cloud_Ethernet2 | routed | - | 100.64.2.2/24 | default | - | False | - | - |
| Ethernet2 | p2p_pf2_Ethernet2 | routed | - | 192.168.2.1/24 | default | - | False | - | - |
| Ethernet3 | p2p_wan1-site5_Ethernet4 | routed | - | 192.168.3.1/24 | default | - | False | - | - |
...
!
interface Ethernet1
   description p2p_inet-cloud_Ethernet2
   no shutdown
   no switchport
   ip address 100.64.2.2/24
!
interface Ethernet2
   description p2p_pf2_Ethernet2
   no shutdown
   no switchport
...
!
interface Ethernet3
   description p2p_wan1-site5_Ethernet4
   no shutdown
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | Router_ID | default | 10.255.255.3/32 |
